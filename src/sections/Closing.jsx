...
const FAQS = [
  ...
  { q: 'Do I need to buy a portrait to use it?', a: 'Not at all. The portrait studio is a vendor in the marketplace—a lovely one, and where all this started—but the napp stands on its own. Start free.' },
